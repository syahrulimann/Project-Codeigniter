    ...
    <div id="app">
        <div class="main-wrapper">
                ...
                <aside id="sidebar-wrapper">
                    <div class="sidebar-brand sidebar-logo">
                        <a href="<?php echo base_url('dashboard'); ?>">
                            <img src="<?php echo base_url('assets/images/admin/logo_cp.jpeg'); ?>" class="main-logo" alt="Logo Gandaria City">
                        </a>
                    </div>
            ...
            <footer class="main-footer">
                <?php $copyright_year = '2023';?>
                <div class="footer-left">
                    Copyright &copy; <?php echo $copyright_year; ?> <div class="bullet"></div> <a href="#">Kelompok 2</a>
                </div>
            </footer>
        </div>
    </div>
