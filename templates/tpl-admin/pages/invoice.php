<div class="invoice">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="invoice-title">
                    ...
                    <div class="invoice-number">#<?php echo $get_inv_data->transaction_no; ?></div>
                </div>
                <hr>
                <div class="row">
                    <div class="col-md-6">
                        <address>
                            ...
                            Rizalul Fahmi<br>
                            Letjen S. Parman No.kav.28, Tj. Duren Sel.,<br>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 text-md-right">
                        <address>
                            ...
                            <?php
                            $trx_day   = date('d', strtotime($get_inv_data->transaction_date));
                            $trx_month = date('m', strtotime($get_inv_data->transaction_date));
                            $trx_year  = date('Y', strtotime($get_inv_data->transaction_date));
            ...
            <div class="col-md-12">
                ...
                <div class="table-responsive">
                    <table class="table table-striped table-hover table-md">
                        ...
                        <tr>
                            ...
                            <td class="text-center"><?php echo $get_inv_data->transaction_rent_total_month; ?> bulan</td>
                ...
                <div class="row mt-4">
                    ...
                    <div class="col-lg-4 text-right">
                        ...
                        <!-- <a href="#" class="btn btn-warning">Cetak Invoice PDF</a> -->
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="text-md-left">
        ...
        ?>
            <?php if (
                $get_inv_data->payment_status_code == 1 and $get_inv_data->payment_verif_code == 1
